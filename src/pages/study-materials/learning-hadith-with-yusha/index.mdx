...
<Text variant="h3" mt={5}>
  হাদীস শিখি ইউশার সাথে বইয়ের আরবী ও বাংলা হাদীসের সঠিক উচ্চারণ
</Text>
...
<Video
  videoSrcURL="https://www.youtube.com/embed/AipErzpJVAQ"
  videoTitle='"হাদীস শিখি ইউশার সাথে-২" বইয়ের আরবী ও বাংলা হাদীসের সঠিক উচ্চারণ'
  frameWidth="720px"
  frameHeight="504px"
  width="100%"
  mb={4}
