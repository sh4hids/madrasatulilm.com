...
<SEO pageTitle={books[30].name} seoImage={`/assets/images/${books[30].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[30].image}`} alt={books[30].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[30].description} />
<Text>
মূল্য: <br /> - {books[30].prices.hardCover} <br />
{books[30].prices.paperback ? `- ${books[30].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
