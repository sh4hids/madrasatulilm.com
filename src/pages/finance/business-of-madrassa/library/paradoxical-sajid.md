...
<SEO pageTitle={books[12].name} seoImage={`/assets/images/${books[12].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[12].image}`} alt={books[12].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[12].description} />
<Text>
মূল্য: <br /> - {books[12].prices.hardCover} <br />
{books[12].prices.paperback ? `- ${books[12].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
