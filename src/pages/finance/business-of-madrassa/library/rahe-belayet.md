...
<SEO pageTitle={books[20].name} seoImage={`/assets/images/${books[20].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[20].image}`} alt={books[20].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[20].description} />
<Text>
মূল্য: <br /> - {books[20].prices.hardCover} <br />
{books[20].prices.paperback ? `- ${books[20].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
