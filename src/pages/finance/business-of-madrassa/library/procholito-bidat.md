...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[7].image}`} alt={books[7].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[7].description} />
<Text>
মূল্য: <br /> - {books[7].prices.hardCover} <br />
{books[7].prices.paperback ? `- ${books[7].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
