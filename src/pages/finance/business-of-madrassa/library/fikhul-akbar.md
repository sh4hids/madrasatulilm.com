...
<SEO pageTitle={books[19].name} seoImage={`/assets/images/${books[19].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[19].image}`} alt={books[19].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[19].description} />
<Text>
মূল্য: <br /> - {books[19].prices.hardCover} <br />
{books[19].prices.paperback ? `- ${books[19].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
