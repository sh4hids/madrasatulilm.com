...
<SEO pageTitle={books[13].name} seoImage={`/assets/images/${books[13].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[13].image}`} alt={books[13].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[13].description} />
<Text>
মূল্য: <br /> - {books[13].prices.hardCover} <br />
{books[13].prices.paperback ? `- ${books[13].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
