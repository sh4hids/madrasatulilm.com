...
<SEO pageTitle={books[21].name} seoImage={`/assets/images/${books[21].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[21].image}`} alt={books[21].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[21].description} />
<Text>
মূল্য: <br /> - {books[21].prices.hardCover} <br />
{books[21].prices.paperback ? `- ${books[21].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
