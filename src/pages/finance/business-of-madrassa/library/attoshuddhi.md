...
<SEO pageTitle={books[3].name} seoImage={`/assets/images/${books[3].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[3].image}`} alt={books[3].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[3].description} />
<Text>
মূল্য: <br /> - {books[3].prices.hardCover} <br />
{books[3].prices.paperback ? `- ${books[3].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
