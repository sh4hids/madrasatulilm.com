...
<SEO pageTitle={books[4].name} seoImage={`/assets/images/${books[4].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[4].image}`} alt={books[4].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[4].description} />
<Text>
মূল্য: <br /> - {books[4].prices.hardCover} <br />
{books[4].prices.paperback ? `- ${books[4].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
