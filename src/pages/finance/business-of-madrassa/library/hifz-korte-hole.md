...
<SEO pageTitle={books[5].name} seoImage={`/assets/images/${books[5].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[5].image}`} alt={books[5].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[5].description} />
<Text>
মূল্য: <br /> - {books[5].prices.hardCover} <br />
{books[5].prices.paperback ? `- ${books[5].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
