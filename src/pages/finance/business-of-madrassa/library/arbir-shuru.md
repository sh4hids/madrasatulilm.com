...
<SEO pageTitle={books[27].name} seoImage={`/assets/images/${books[27].image}`}/>
...
<Box width={[1, 1 / 2]} px={3} py={3}>  
 <img src={`/assets/images/${books[27].image}`} alt={books[27].name} />
</Box>
<Box width={[1, 1 / 2]} px={3} py={3}>
<Text variant="raw" html={books[27].description} />
<Text>
মূল্য: <br /> - {books[27].prices.hardCover} <br />
{books[27].prices.paperback ? `- ${books[27].prices.paperback}` : ''}
</Text>
</Box>
</Flex>
