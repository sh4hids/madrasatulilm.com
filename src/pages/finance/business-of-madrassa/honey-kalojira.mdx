...
<Flex mx={[0, -2]} flexWrap="wrap" mt={3}>
  ...
  <Box width={[1, 1 / 2]} px={3} py={3}>
    ...
    <Text variant="h6">এমনই একটি পণ্য, কালজিরা ফুলের মধু:  </Text>
    <Text>মাদারিপুর, ফরিদপুর, শরিয়তপুর থেকে সংগ্রহ করা হয় এই উপাদেয় কালজিরা ফুলের মধু।</Text>
    <Text>
      মূল্য: <br />- ৫০০ গ্রাম ৪০০ টাকা 
    </Text>
