...
<Flex mx={[0, -2]} flexWrap="wrap" mt={3}>
  ...
  <Box width={[1, 1 / 2]} px={3} py={3}>
    ...
    <Text variant="h6">এমনই একটি পণ্য, বরই ফুলের মধু:   </Text>
    <Text>সাতক্ষীরা সদরের তালা ও কলারোয়া উপজেলা থেকে সংগ্রহ করা হয় এই অতি মিষ্টি বরই ফুলের মধু।</Text>
    <Text>
      মূল্য: <br />- ৫০০ গ্রাম ৩০০ টাকা 
    </Text>
